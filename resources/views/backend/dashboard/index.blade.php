                                ...
                                <tbody>
                                    @forelse ($cuti as $i)
                                        <tr>
                                            ...
                                            <td style="vertical-align: top !important;">
                                                <a href="/{{ $i->file }}" target="_blank" class="text-primary">
                                                    <i class="bi bi-file-earmark-text"></i>
                                                </a>
                                            </td>
                                        </tr>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div id="form_absensi_detail" style="display:none;">
                                        <div class="text-center">
                                            ...
                                            <canvas id="canvas" width="350" height="260"
                                                class="d-none"></canvas>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <span class="text-danger" style="font-size: 12px;">
                                                *Update lokasi kerja anda agar sesuai dengan jarak lokasi kerja saat ini.
                                                Update lokasi
                                                kerja di
                                                halaman
                                        ...
                                        <div id="field_non_reguler" class="border rounded p-3 mt-3"
                                            ...
                                            <small class="text-danger">
                                                Wajib diisi apabila absensi dilakukan di luar jam reguler atau di luar area
                                                kantor.
                                            </small>
