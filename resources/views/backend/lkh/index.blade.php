        ...
        <div class="col-md-12 text-white">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data LKH</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2">Form LKH</h5>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Uraian Kegiatan<sup class="text-danger">*</sup></label>
                            <textarea name="uraian_kegiatan" id="uraian_kegiatan" class="form-control" required placeholder="Uraian Kegiatan"
...
@push('script')
    <script src="{{ asset('js/backend/lkh/index.js') }}"></script>
@endpush
