...
$('#modal').on('show.bs.modal', function (event) {
    ...
    if (recipient) {
        ...
        modal.find('#lokasi_kerja').val(cokData[0].lokasi_kerja);
...
form.onsubmit = function (e) {
    ...
    axios.post(
        formData.get('id') == "" ? "/store-lokasi-kerja" : "/update-lokasi-kerja",
        formData
    )
        .then(res => {
...
hapusData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            axios.post("/delete-lokasi-kerja", { 
                id 
            })
                .then(res => {
