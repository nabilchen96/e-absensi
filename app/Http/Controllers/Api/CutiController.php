...
class CutiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $idPengajuan = 'CT' . now()->format('YmdHis');
        ...
        try {
            ...
            return response()->json([
                'responCode' => 1,
                'respon' => 'Cuti berhasil disimpan untuk rentang tanggal '.$request->tanggal_awal.' s/d '.$request->tanggal_akhir
            ]);
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'responCode' => 1,
                'respon' => 'Data cuti berhasil diupdate'
            ]);
    ...
    public function updateStatus(Request $request)
    {
        ...
        if ($request->id) {
            ...
            if (!$izin) {
                return response()->json([
                    'responCode' => 0,
                    'respon' => 'Data cuti tidak ditemukan',
                ]);
            }
        ...
        if ($request->id_pengajuan) {
            ...
            if ($data->isEmpty()) {
                return response()->json([
                    'responCode' => 0,
                    'respon' => 'Data cuti (id_pengajuan) tidak ditemukan',
                ]);
            }
        ...
        return response()->json([
            'responCode' => 1,
            'respon' => 'Status Cuti berhasil diperbarui'
        ]);
    }
